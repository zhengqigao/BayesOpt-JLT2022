...
if __name__ == '__main__':
    ...
    opt = differential_evolution(obj_func, bound, maxiter=args.N_iter, popsize=6, disp=True) # (maxiter + 1) * popsize * len(x)
    file_suffix = 'ga' + '_' + str(args.targ_power_ratio) + '_' + str(args.seed)
